...
mainAudio.addEventListener("timeupdate", (e)=>{
    ...
    repeatBtn.addEventListener("click", ()=>{
        //first we get the innerText of the icon the we2ll change accordingly
        ...
        switch(getText){
            case "repeat": // if this icon is repeat then simply we call the nextMusic function so the next song will play
               ...
               case "shuffle": // if icon is shuffle then change it to repeat
                  ...
                  }while(musicIndex == randIndex); //this loop run until the next random number wont be the same of current music index
